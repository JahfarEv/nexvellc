...
// // Categorized Development Services
...
//         description:
//           "Cloud-based software solutions with subscription management, multi-tenancy, and scalable infrastructure.",
//         features: [
//           "User Authentication",
//           "Payment Integration",
//           "Analytics Dashboard",
...
//         description:
//           "Full-featured online stores with product management, cart functionality, and secure checkout.",
//         features: [
//           "Product Catalog",
//           "Shopping Cart",
//           "Payment Gateway",
...
//         description:
//           "Point of Sale systems for retail, restaurants, and businesses with inventory management.",
//         features: [
//           "Inventory Tracking",
//           "Sales Reports",
//           "Customer Management",
...
//         description:
//           "Showcase your work, skills, and achievements with stunning visual layouts.",
//         features: [
//           "Project Gallery",
//           "Client Testimonials",
//           "Contact Form",
...
//         description:
//           "Corporate websites that establish credibility and drive conversions.",
//         features: [
//           "Service Pages",
//           "Team Profiles",
//           "Newsletter Signup",
...
//   const words = ["Enterprise Solutions", "ERP Systems", "POS Platforms", "Digital Transformation"];
...
//           <motion.div variants={staggerContainer} initial="hidden" animate="visible" className="space-y-6 w-full">
...
//                 <span className="bg-gradient-to-r from-slate-900 via-blue-800 to-cyan-700 bg-clip-text text-transparent">Innovation</span><br />
//                 <span className="text-slate-900">Meets </span>
//                 <span className="bg-gradient-to-r from-blue-700 to-cyan-600 bg-clip-text text-transparent">Execution</span>
//               </h1>

//               <div className="flex items-center justify-center gap-2 flex-wrap">
//                 <span className="text-xl md:text-2xl text-slate-600">Powering</span>
//                 <div className="relative">
//                   <span className="text-xl md:text-2xl font-semibold bg-gradient-to-r from-blue-700 to-cyan-600 bg-clip-text text-transparent">{typedText}</span>
//                   <span className="absolute -right-3 top-0 w-0.5 h-7 bg-gradient-to-b from-blue-600 to-cyan-600 animate-blink"></span>
//                 </div>
//               </div>
//             </motion.div>

//             <motion.div variants={staggerItem} className="flex flex-wrap gap-4 justify-center pt-2">
//               <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="bg-slate-900 text-white px-6 py-2.5 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
//                 Start a Project →
//               </motion.button>
//               <motion.button whileHover={{ scale: 1.02 }} whileTap={{ scale: 0.98 }} className="bg-white border-2 border-slate-200 text-slate-700 px-6 py-2.5 rounded-xl font-semibold hover:border-blue-600 hover:text-blue-600 transition-all duration-300 shadow-sm">
//                 View Solutions
//               </motion.button>
//             </motion.div>
...
//     >
//       <div className="p-6">
//         <motion.div variants={iconVariants} className="text-5xl mb-3">{product.icon}</motion.div>
//         <h3 className="text-xl font-bold text-gray-800">{product.name}</h3>
//         <p className="text-[#2E8A99] font-semibold text-xs mt-1">{product.tagline}</p>
//         <p className="text-gray-600 mt-2 leading-relaxed text-sm">{product.description}</p>
...
//           <span className="text-xs uppercase tracking-wider text-[#2E8A99] font-semibold bg-[#E9F4F7] px-3 py-0.5 rounded-full inline-block">flagship products</span>
//           <h2 className="text-3xl md:text-4xl font-bold mt-3 text-gray-800">
//             Our companies & <span className="bg-gradient-to-r from-[#0F2B3D] to-[#2E8A99] bg-clip-text text-transparent">innovations</span>
//           </h2>
//           <p className="text-gray-500 mt-2">Driving the next-gen digital experience through dedicated platforms.</p>
//         </div>
...
// // Service Card Component with Attractive Animation
...
//     >
//       <div className="p-5">
//         <motion.div variants={iconVariants} className="text-3xl mb-2">{service.icon}</motion.div>
...
//           <div className="inline-block rounded-full bg-[#E9F4F7] px-3 py-0.5 text-xs font-medium text-[#1B4F6E]">Our Expertise</div>
//           <h2 className="text-3xl md:text-4xl font-bold mt-3 text-gray-800">
//             Web & Application <span className="bg-gradient-to-r from-[#0F2B3D] to-[#2E8A99] bg-clip-text text-transparent">Development</span>
//           </h2>
//           <p className="text-gray-500 max-w-2xl mx-auto mt-2">Comprehensive development solutions tailored to your business needs</p>
//         </div>

//         <div className="mb-12">
//           <div className="flex items-center gap-2 mb-6">
//             <div className="text-2xl">{developmentServices.webApplications.icon}</div>
//             <div>
//               <h3 className="text-xl font-bold text-gray-800">{developmentServices.webApplications.title}</h3>
//               <div className="w-16 h-0.5 bg-gradient-to-r from-blue-500 to-cyan-500 rounded-full mt-1"></div>
//             </div>
//           </div>
//           <div className="grid md:grid-cols-3 gap-5">
//             {developmentServices.webApplications.items.map((service, idx) => (
...
//         <div className="mb-12">
//           <div className="flex items-center gap-2 mb-6">
//             <div className="text-2xl">{developmentServices.businessWebsites.icon}</div>
//             <div>
//               <h3 className="text-xl font-bold text-gray-800">{developmentServices.businessWebsites.title}</h3>
//               <div className="w-16 h-0.5 bg-gradient-to-r from-purple-500 to-pink-500 rounded-full mt-1"></div>
//             </div>
//           </div>
//           <div className="grid md:grid-cols-2 gap-5">
//             {developmentServices.businessWebsites.items.map((service, idx) => (
//               <ServiceCard key={idx} service={service} index={idx} />
//             ))}
//           </div>
//         </div>

//         <div className="mt-10 bg-gradient-to-r from-[#0F2B3D] to-[#1B4F6E] rounded-2xl p-6 md:p-8 text-white flex flex-col md:flex-row justify-between items-center gap-4 shadow-xl">
//           <div>
//             <p className="text-xl md:text-2xl font-bold">Ready to build your project?</p>
//             <p className="text-blue-100 text-sm mt-1">Let's discuss your requirements and bring your idea to life.</p>
//           </div>
//           <motion.button whileHover={{ scale: 1.05 }} whileTap={{ scale: 0.95 }} className="bg-white text-[#0F2B3D] px-6 py-2 rounded-xl font-bold shadow-md hover:bg-gray-100 transition-all">
//             Start a project →
//           </motion.button>
//         </div>
//       </div>
